                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500 text-justify">Introducing Bionic, a decision support system for medical professionals from Hyzync, designed to analyze the risk of fatal cardiovascular events. Bionic only requires a simple ECG and is highly cost-effective. Try Bionic in the select few hospitals where it is now integrated. Healthcare institutions interested in integrating Bionic can contact us for more information.</div>
